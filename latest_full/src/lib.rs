...
pub trait DelegationFull:
    ...
    + delegation_latest::dharitri_sc_modules::dns::DnsModule
    + delegation_latest::dharitri_sc_modules::features::FeaturesModule
    + delegation_latest::dharitri_sc_modules::pause::PauseModule
{
    // METADATA
